export interface PriceSuggestion {
  sku: string; // sku of the product in Pricen
  strategyId: string; // id of the strategy in Pricen
  strategyName: string; // name of the strategy in Pricen
  ...
  shopName: string; // name of the shop in Pricen
  }
